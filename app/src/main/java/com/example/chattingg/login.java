        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ((TextUtils.isEmpty(Email))){
                    ...
                    progressDialog.dismiss();
                    email.setError("Geçerli email giriniz:");
                    
                } else if (password.length()<6) {
                    progressDialog.dismiss();
                    password.setError("En az 6 karakter giriniz:");
                    Toast.makeText(login.this,"En az 6 karakter içermelidir!", Toast.LENGTH_SHORT).show();
                }else{
